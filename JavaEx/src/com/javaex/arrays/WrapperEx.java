...
public class WrapperEx {
	...
	public static void main(String[] args) {
		...
		// 어쩄든 다른 메모리를 차지 (다른 객체)
		System.out.println("i와 i2가 같은가? " + (i == i2));
		System.out.println("i와 i2가 값이 같은가? " + (i.intValue() == i2.intValue()));
